...
class MeasurementWindow:
    ...
    def __init__(self):
        ...
        self._acc_pvs_dur = (
            0  # current accumulated time at end of measurement window, for the entire PVS
        )
    ...
    def add_frame(self, frame):
        ...
        frame['representation'] = (
            get_chunk_hash(frame, 'audio') if 'fps' not in frame else get_chunk_hash(frame, 'video')
        )
    ...
    def stream_finished(self):
        ...
        while output_sample_timestamp <= final_sample_timestamp:
            ...
            removed_duration = 0
            while (
                round(self._frames[0]['dts'], 5) < output_sample_timestamp - self._half_window_size
            ):
