...
ground_truth_qoe_df[['video', 'start_quality', 'end_quality', 'viewing_distance']] = (
    ground_truth_qoe_df['objects'].str.split('_', expand=True)
)
...
ground_truth_qoe_grouped_df = ground_truth_qoe_df.groupby(
...
resolution_map = {'r1': '1920x1080', 'r3': '1920x1080', 'r5': '1920x1080'}
...
def get_rmse_by_coeffs(coeff):
    ...
    if rmse < min_rmse:
        min_rmse = rmse
        print(
            'Min RMSE for pid {}: {}.\t Coeffs: {} {} {} {}'.format(
                os.getpid(), rmse, coeff['q1'], coeff['q2'], coeff['q3'], coeff['mode0']
            )
        )
...
if __name__ == '__main__':
    ...
    with open(
        './optimized_p1203_coeff_mode0_static_resolution_{}_{}_{}.csv'.format(
            a1_start, a1_end, current_time
        ),
        'w',
    ) as f:
        f.write('====== Coeffs ====\n' + str(all_rmse[0][0]))
